...
var (
	...
	ErrFailedToGetDelValue     = errors.New("[CACHE] failde to get and delete value")
	ErrFailedToGetDeleteSingle = errors.New("[CACHE] failde to get and delete single value")
