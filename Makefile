...
GOWORK ?= off
GO_TEST_FLAGS ?=
RACE_PACKAGES ?= ./threadsafemap ./yathreadsafeset ./yaringbuffer ./yascheduler ./yascheduler/protocol ./yascheduler/store ./yascheduler/store/memstore ./yascheduler/store/redisstore ./yascheduler/engine
